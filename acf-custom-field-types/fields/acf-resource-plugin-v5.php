<?php
class Vietveb_ACF_field_resource_plugin extends acf_field
{
    /*
    *  __construct
    *
    ...
    */
    ...
    {
        $this->name = 'resource_plugin';
        $this->label = __('Resource Plugins', 'acf-posttype_select');
        $this->category = 'Basic';
        $this->defaults = array(
            'multiple'      => 1,
            'allow_null'    => 0,
    ...
    */
    ...
    {
        $args = apply_filters('vietveb_acf_field_resource_plugin/get_post_types_args', array( 
...
// create field
new Vietveb_ACF_field_resource_plugin();
